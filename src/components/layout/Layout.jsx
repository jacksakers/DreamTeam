...
const Layout = ({ children }) => {
  return (
    <div className="min-h-screen bg-[var(--color-cream)]">
      ...
      <div className="fixed top-0 -right-15 w-64 h-64 opacity-10 pointer-events-none">
        <img src={leafPattern} alt="" className="w-full h-full" />
      </div>
      <div className="fixed bottom-0 -left-15 w-64 h-64 opacity-10 rotate-180 pointer-events-none">
        <img src={leafPattern} alt="" className="w-full h-full" />
      </div>
